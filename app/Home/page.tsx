            ...
            <div className="flex flex-col gap-6">
                <h1 className="font-black text-6xl">
                    <span style={{ color: 'black', fontWeight: 'bold'}}>
                        <Typewriter
                            words={['What is Mentorify', 'AI Based guidance']}
                            loop={1000}
                            cursor
                            cursorStyle='_'
                            typeSpeed={70}
                ...
                <p className="text-xl">Mentorify is a interactive AI based model to help students choose careers and know their capabilities</p>
